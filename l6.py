отре'''1 часть – написать программу в соответствии со своим вариантом задания. 
...
endings = {
    'Единственное': {
        'именительный': ' компьютер',
        'родительный': ' компьютера',
        'дательный': ' компьютеру',
        'винительный': ' компьютер',
        'творительный': ' компьютером',
        'предложный': ' компьютере'
    },
    'Множественное': {
        'именительный': ' компьютеры',
        'родительный': ' компьютеров',
        'дательный': ' компьютерам',
        'винительный': ' компьютеры',
        'творительный': ' компьютерами',
        'предложный': ' компьютерах'
    }
}
...
def gen_lex_it(word):
    s_end = [' компьютер', ' компьютера', ' компьютеру', ' компьютер', ' компьютером', ' о компьютере']
    p_end = [' компьютеры', ' компьютеров', ' компьютерам', ' компьютеры', ' компьютерами', ' о компьютерах']
